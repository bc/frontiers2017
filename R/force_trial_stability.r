...
{
A_fits <- lapply(seq(x,y, by=5),function(n) get_A_fit_from_80_20_split_n_sample(input_output_data=input_output_data, muscles_of_interest=muscles_of_interest, force_names_to_predict=force_names_to_predict,n))
