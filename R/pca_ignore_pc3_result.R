...
p_sd <- p_sd + theme_classic() + xlab("Task intensity in distal direction (N)") + ylab("Standard Deviation of muscle activation across samples within a given task intensity")
ggsave("standard_deviation_of_har_muscle_activations_at_each_task_intensity.png",p_sd,width=4, height=6)
