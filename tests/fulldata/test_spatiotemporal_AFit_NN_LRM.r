...
response_2A <- fread("~/Desktop/responses/2/noiseResponse2017_12_04_06_03_59_EXMECH_2A_3tap.txt", data.table=FALSE)

filename_2A <- "noiseResponse2017_12_04_06_03_59_EXMECH_2A_3tap"
  ...
  untransformed_noise_response <- response_2A
