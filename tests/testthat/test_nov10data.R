...
plot_list <- list(plot_input_output_signals(head(sample_maps_data, 10000)),
...
ggsave("../../output/xray_for_noiseReponse.pdf", arrangeGrob(grobs=plot_list, nrow = 2), width=30, height=30)
...
task_multiplier_bounds <- c(0, 1)  #if c(0.0,0.0) then a null task.
